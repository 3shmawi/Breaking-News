class MostafaNewsModel2 {
  ...
  late final List<Articles2> articles;

  MostafaNewsModel2.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    totalResults = json['totalResults'];
    articles =
        List.from(json['articles']).map((e) => Articles2.fromJson(e)).toList();
  }
